...
<nav class="blue">
    <div class="nav-wrapper container">
      <a class="brand-logo center">CADASTRO DE CLIENTES PJ</a>
...
<form action="{{ route('admin.cadastropj')}}" method="POST">
  @csrf
  <br><br>
    ...
    <div class="input-field col s6">
        <input name="cnpj" placeholder ="CNPJ DA EMPRESA" id="cnpj" type="number" class="validate">
    ...
    <div class="center">
        <button type="submit" class="btn" name="btn-login"> CADASTRAR EMPRESA CLIENTE </button>
    </div>
